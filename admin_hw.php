...
if($rows > 0){
    ...
    <td style='border: 1px solid black'><a href='hw_del.php?id=".$row['id']."' style='color: green'>Delete</a>
	<br><a href='hw_edit.php?id=".$row['id']."' style='color: green'>Edit</a></td>";
	}
} else {
	
	$tables = "No questions found, <a href='hw_add.php' style='color: green;'>want to add?</a>";
...
<body>
	...
	<a href="hw_add.php" style="color: green;">Add Question</a>
...
<br>
<a href="hw_empty.php" style="color: green;">Empty List</a>
<br><br>
	</div>
	</div>
</body>
