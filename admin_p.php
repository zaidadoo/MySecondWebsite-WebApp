...
if($rows > 0){
	while($row = mysqli_fetch_array($ex)){
		$tables .= "<tr>
    <td style='border: 1px solid black'>".$row['cat']."</td>
    ...
    <td style='border: 1px solid black'><a href='p_del.php?id=".$row['id']."' style='color: green'>Delete</a>
	<br><a href='p_edit.php?id=".$row['id']."' style='color: green'>Edit</a></td>";
	}
} else {
	
	$tables = "No questions found, <a href='p_add.php' style='color: green;'>want to add?</a>";
...
<body>
	...
	<a href="p_add.php" style="color: green;">Add Question</a>
	<table style="padding: 5px; border: 1px solid black">
  <tr>
    <th style="border: 1px solid black; background: green; color: white">Category</th> 
...
<br>
<a href="p_empty.php" style="color: green;">Empty List</a>
<br><br>
	</div>
	</div>
</body>
